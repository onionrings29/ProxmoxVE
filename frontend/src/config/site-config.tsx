...
export const navbarLinks = [
  {
    href: `https://github.com/onionrings29/${basePath}`,
    event: "GitHub",
  ...
  {
    href: `https://github.com/onionrings29/${basePath}/blob/main/CHANGELOG.md`,
    event: "Changelog",
  ...
  {
    href: `https://github.com/onionrings29/${basePath}/discussions`,
    event: "Discussions",
