...
service:
  ...
  community-scripts/ProxmoxVE:
    latest_version:
      ...
      use_prerelease: false
    dashboard:
      icon: https://raw.githubusercontent.com/onionrings29/ProxmoxVE/refs/heads/main/misc/images/logo.png
      icon_link_to: https://helper-scripts.com/
      web_url: https://github.com/onionrings29/ProxmoxVE/releases
EOF
msg_ok "Setup Config"
